...
import { useAuthStore, useUserStore } from "../index";
import { computed } from 'vue';

const authStore = useAuthStore();
const userStore = useUserStore()
const emit = defineEmits(["updateEComStore", "updateShopifyConfig"])
...
const userAppState = computed(() => ({
  ...
  shopifyConfigs: userStore.getShopifyConfigs,
  currentShopifyConfig: userStore.getCurrentShopifyConfig
}));
