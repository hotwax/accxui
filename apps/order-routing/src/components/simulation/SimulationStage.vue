<template>
  <div class="stage-wrapper">
    ...
    <div class="stage" aria-hidden="true">
      ...
      <p class="thought">
        <span v-if="pose === 'thinking' && currentOrder">
          …thinking order <strong>{{ currentOrder.orderId }}</strong><span class="dots" aria-hidden="true">...</span>
        </span>
        <span v-else-if="pose === 'routing' && currentOrder">
